...
SET mapreduce.reduce.java.opts='-Djava.net.preferIPv4Stack=true -Xmx16000m';
...
DROP TABLE IF EXISTS bihp_sand.cx_nfl_recording;
CREATE TABLE IF NOT EXISTS bihp_sand.cx_nfl_recording
...
WHERE
     trim(event_type) = 'RecordingEvent'
GROUP BY 
 event_date_local,
 cust_acct_num,
 major_chan_num
