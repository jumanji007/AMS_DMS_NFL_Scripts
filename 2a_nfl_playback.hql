...
DROP TABLE IF EXISTS bihp_sand.cx_nfl_playback;
CREATE TABLE IF NOT EXISTS bihp_sand.cx_nfl_playback
...
WHERE
    (trim(event_type) = 'PlaybackEvent' and trim(event_source) = 'Playback')
GROUP BY 
 event_date_local,
 cust_acct_num,
 major_chan_num
